                ...
                <div class="card-body">
                   <center><h2 class="title">Teacher's Registration Form</h2></center> 
                    <form method="POST" action="">
                        ...
                        <div class="input-group">
                            <input required="required" class="input--style-4" type="text" placeholder="NAME *" name="name">
                        </div>
                           <div class="input-group">
                            <input required="required" class="input--style-4" type="text" placeholder="FATHER NAME *" name="fname">
                        </div>
                           <div class="input-group">
                            <input required="required" class="input--style-4" type="email" placeholder="PROPER EMAIL / User Name *" name="email">
                        </div>
                        <div class="input-group">
                          ...
                          <div class="input-group">
                            <input required="required"  type="number"  placeholder="MOBILE NO. *" name="mob">
                        </div>
                        ...
                        <div class="input-group">
                            <input required="required" class="input--style-4" type="text" placeholder="ADDRESS *" name="address">
                        </div>
                       
                         <div class="input-group">
                            <input required="required" class="input--style-4" type="text" placeholder="ENTER YOUR SPECIALIZATION SUBJECT 1 *" name="sub1">
                        </div>

                         <div class="input-group">
                            <input class="input--style-4" type="text" placeholder="ENTER YOUR SPECIALIZATION SUBJECT 2" name="sub2">
                        </div>

                         <div class="input-group">
                            <input  class="input--style-4" type="text" placeholder="ENTER YOUR SPECIALIZATION SUBJECT 3" name="sub3">
                        </div>
                        <div class="input-group">
