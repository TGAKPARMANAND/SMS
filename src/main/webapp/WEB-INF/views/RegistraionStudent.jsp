 ...
 <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo" >
        <div class="wrapper wrapper--w680">
           ...
           <div class="input-group">
                            ...
                            <input class="input--style-4" type="text" placeholder="Enter the Enquiry ID *" name="enqid" id="enqid" value="10">
           ...
           <div class="input-group">
                     ...
                     <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input required="required" class="input--style-4" type="test" placeholder="DATE OF BIRTH *" name="dob" id="dob" value="08/08/1984">
                       
                               </div>
                               <div class="input-group">
                            <input required="required"  type="number" class="input--style-4" placeholder="AADHAR CARD NO. (OPTIONAL)" name="adhar" id="adhar" value="754198027945">
                               ...
                               <div class="input-group">
                                        ...
                                        <select name="gender" id="gender" class="input--style-4">
                                            <option disabled="disabled" selected="selected" value="Male">GENDER *</option>
                                   ...
                                   <div class="input-group">
                                        <select name="category" id="cat" class="input--style-4" >
                                            <option disabled="disabled" selected="selected" value="sc">CATEGORY *</option>
                                            <option>SC</option>
                                            <option>ST</option>
                                            <option>OBC</option>
                                ...
                                <select name="category" id="qualification" class="input--style-4">
                                    <option disabled="disabled" selected="selected" value="12">EDUCATION LEVEL *</option>
                                    <option>10</option>
                                    <option>12</option>
                                    <option selected="selected">UG</option>
                                       <option>PG</option>
                                    <option>Other</option>
                            ...
                            <input required="required" class="input--style-4" type="number" placeholder="PIN CODE *" name="pin" id="pin" value="473001">
                        
                        </div>
                            <div class="input-group">
                            <input required="required" class="input--style-4" type="text" placeholder="ANY JOB *" name="job" id="job" value="bank">
                        
                        </div>
                        <div class="input-group">
                            <input required="required" class="input--style-4" type="time" placeholder="BATCH TIME *" name="btime" id="btime" value="12:32">
