                   ...
                   <center><h4 class="title">Enquiry Registration Form</h4></center> 
                    <form method="POST" action="">
                        ...
                        <div class="input-group">
                            <input required="required" class="input-style-4" type="text" placeholder="NAME *" name="name" id="name" value="jay">
                        </div>
                           <div class="input-group">
                            <input required="required" class="input-style-2" type="text" placeholder="FATHER NAME *" name="fathname" value="laa" id="fathname" >
                        </div>
                           <div class="input-group">
                            <input required="required" class="input-style-2" type="email" placeholder="PROPER EMAIL *" name="email" id="email" value="jay08jha@gmail.com">
                        </div>
                          
                          <div class="input-group">
                            <input required="required" class="input-style-2" type="text"  placeholder="MOBILE NO. *" name="mob" id="mobile" value="7987121389">
                        </div>
                                <div class="input-group">
                        ...
                        <div class="input-group">
                            <input required="required" class="input-style-2" type="text" placeholder="ADDRESS *" name="address" value="guna" id="address">
                        </div>
                        <div class="input-group" required="required">
                         ...
                         <div class="input-group">
                            <input required="required" class="input-style-2" type="text" placeholder="ENTER STUDENT CATEGORY" name="desc"  id ="cd" value="obc">
                        </div>
                        <div class="input-group">
                            <input required="required" class="input-style-2" type="text" placeholder="ENTER YOUR ENQUIRY " name="enquiry"  id="enqury" value="addmission">
                        </div>
